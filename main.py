...
cursor = conn.cursor()
# cursor.execute('''CREATE TABLE asus(
#                 modul   VARCHAR(200),
#                 price   FLOAT,
#                 score   FLOAT
#                 );''')
# cursor.execute('''CREATE TABLE msi(
#                 modul   VARCHAR(200),
#                 price   FLOAT,
#                 score   FLOAT
#                 );''')
# cursor.execute('''CREATE TABLE lenovo(
#                 modul   VARCHAR(200),
#                 price   FLOAT,
#                 score   FLOAT
#                 );''')
# cursor.execute('''CREATE TABLE hp(
#                 modul   VARCHAR(200),
#                 price   FLOAT,
#                 score   FLOAT
#                 );''')
# cursor.execute('''CREATE TABLE acer(
#                 modul   VARCHAR(200),
#                 price   FLOAT,
#                 score   FLOAT
#                 );''')
